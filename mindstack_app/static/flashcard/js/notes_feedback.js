...
// Prevent duplicate declaration if AI modal already defined these
if (typeof currentAiItemId === 'undefined') { var currentAiItemId = null; }
if (typeof currentNoteItemId === 'undefined') { var currentNoteItemId = null; }
if (typeof lastLoadedNoteContent === 'undefined') { var lastLoadedNoteContent = ''; }
