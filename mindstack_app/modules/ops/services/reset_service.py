    ...
    def reset_user_container_progress(user_id: int, container_id: int):
        ...
        try:
            ...
            if item_ids:
                ...
                StudyLog.query.filter(StudyLog.user_id == user_id, StudyLog.item_id.in_(item_ids)).delete(synchronize_session=False)
                ...
                ScoreLog.query.filter(ScoreLog.user_id == user_id, ScoreLog.item_id.in_(item_ids)).delete(synchronize_session=False)
