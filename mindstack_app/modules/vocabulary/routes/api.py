...
from ...vocab_flashcard.services.session_service import LearningSessionService # For active sessions
...
def api_get_set_detail(set_id):
    ...
    try:
        ...
        current_app.logger.error(f"Error getting set detail API: {e}")
