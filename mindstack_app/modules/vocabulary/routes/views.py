...
def modes_selection_page(set_id):
    ...
    """
    container = LearningContainer.query.get_or_404(set_id)
    return render_dynamic_template('modules/vocabulary/modes/index.html', container=container)
...
def item_stats_page(item_id):
    ...
    """
    from mindstack_app.modules.vocabulary.services.stats_item_new import VocabularyItemStats # We will create this or use interface
    # Actually, let's just use the interface as intended
    from ..interface import VocabularyInterface as VocabularyItemStats
    ...
    if request.args.get('modal') == 'true':
        return render_dynamic_template('modules/vocabulary/stats/_item_stats_content.html', stats=stats)
        
    return render_dynamic_template('modules/vocabulary/stats/item_detail.html', stats=stats)
