...
flashcards_bp = Blueprint('content_management_flashcards', __name__) # Đã cập nhật đường dẫn template
...
def list_flashcard_sets():
    ...
    if request.headers.get('X-Requested-With') == 'XMLHttpRequest':
        return render_template('pages/content_management/flashcards/sets/_flashcard_sets_list.html', **template_vars)
    else:
        return render_template('pages/content_management/flashcards/sets/flashcard_sets.html', **template_vars)
...
def manage_flashcard_excel(set_id):
    ...
    return render_template(
        'pages/content_management/flashcards/excel/manage_flashcard_excel.html',
...
def add_flashcard_set():
    ...
    if request.method == 'GET' and request.args.get('is_modal') == 'true':
        return render_template('pages/content_management/flashcards/sets/_add_edit_flashcard_set_bare.html', form=form, title='Thêm Bộ thẻ ghi nhớ', template_url=template_url)
    return render_template('pages/content_management/flashcards/sets/add_edit_flashcard_set.html', form=form, title='Thêm Bộ thẻ ghi nhớ', template_url=template_url)
...
def edit_flashcard_set(set_id):
    ...
    if request.method == 'GET' and request.args.get('is_modal') == 'true':
        return render_template(
            'pages/content_management/flashcards/sets/_add_edit_flashcard_set_bare.html',
            form=form,
    ...
    return render_template(
        'pages/content_management/flashcards/sets/add_edit_flashcard_set.html',
        form=form,
        title='Chỉnh sửa Bộ thẻ ghi nhớ',
        previous_set_id=previous_set_id,
        next_set_id=next_set_id,
...
def list_flashcard_items(set_id):
    ...
    return render_template('pages/content_management/flashcards/items/flashcard_items.html',
                           flashcard_set=flashcard_set,
...
def add_flashcard_item(set_id):
    ...
    # Render template cho modal hoặc trang đầy đủ
    if request.method == 'GET' and request.args.get('is_modal') == 'true':
        return render_template('pages/content_management/flashcards/items/_add_edit_flashcard_item_bare.html', **context)
    return render_template('pages/content_management/flashcards/items/add_edit_flashcard_item.html', **context)
