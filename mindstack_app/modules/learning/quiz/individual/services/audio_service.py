...
class QuizAudioService:
    ...
    def transcribe_quiz_audio(self, task, container_ids=None):
        """
        Scans quiz items for audio content and uses VoiceService to transcribe it to text.
        ...
        try:
            ...
            for item, rel_audio_path in items_to_process:
                ...
                try:
                    ...
                    transcript = self.voice_service.speech_to_text(full_path, lang='vi-VN') # Defaulting to VN
