...
// Local session stats tracking for mobile view
...
function setFlashcardContent(desktopHtml, mobileHtml = null) {
  document.querySelectorAll('.js-flashcard-content').forEach(el => {
    ...
    if (mobileHtml !== null) {
      ...
      // Render giống nhau cho tất cả (fallback)
      el.innerHTML = desktopHtml;
    }
  });
}
...
function renderCard(data) {
  ...
  // Render CẢ HAI versions để có thể resize mượt mà
  let desktopHtml = "";
  let mobileHtml = "";
