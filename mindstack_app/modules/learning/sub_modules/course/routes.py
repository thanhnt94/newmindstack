...
def course_learning_dashboard():
    ...
    return render_template('pages/course/default/course_learning_dashboard.html', current_filter=current_filter)
...
def get_course_sets_partial():
    ...
    return render_template('pages/course/default/_course_sets_selection.html',
...
def get_lesson_list_partial(course_id):
    ...
    return render_template('pages/course/default/_lesson_selection.html', lessons=lessons, course=course)
...
def course_session(lesson_id):
    ...
    return render_template(
        'pages/course/default/course_session.html', 
        lesson=lesson, 
        course=course, 
