...
def quiz_learning_dashboard():
    ...
    return render_template('pages/quiz/dashboard/default/index.html', **template_vars)
...
def get_quiz_modes_partial_all():
    ...
    return render_template(
        'pages/quiz/individual/setup/default/_modes_list.html',
        modes=modes,
        selected_set_id='all',
...
def get_quiz_custom_options(set_id):
    ...
    return render_template(
        'pages/quiz/individual/setup/default/_quiz_custom_options.html',
        container=container,
...
def quiz_session():
    ...
    try:
        ...
        if is_single_mode:
            return render_template('pages/quiz/session/default/_session_single.html')
        else:
            return render_template('pages/quiz/session/default/_session_batch.html')
...
def get_quiz_sets_partial():
    ...
    try:
        ...
        return render_template('pages/quiz/individual/setup/default/_sets_list.html', **template_vars)
