...
Run this from the project root: python -m mindstack_app.modules.admin.api_key_management.test_autogen
"""

from mindstack_app import create_app
from mindstack_app.models import db
from mindstack_app.modules.admin.api_key_management.autogen_service import get_sets_with_missing_content
