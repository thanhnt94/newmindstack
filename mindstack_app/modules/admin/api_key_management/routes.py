...
def list_api_keys():
    ...
    return render_template('pages/admin/api_keys/api_keys.html', keys=keys, logs=logs, pagination=pagination, ai_settings=settings, chart_data=chart_payload)
...
def add_api_key():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('.list_api_keys'))
    return render_template('pages/admin/api_keys/add_edit_api_key.html', form=form, title='Thêm API Key mới')
...
def edit_api_key(key_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('.list_api_keys'))
    return render_template('pages/admin/api_keys/add_edit_api_key.html', form=form, title='Chỉnh sửa API Key')
