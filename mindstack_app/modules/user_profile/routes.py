...
def view_profile():
    ...
    return render_template('user_profile/default/profile.html', user=current_user, badges=badges, telegram_link=telegram_link)
    ...
    if form.validate_on_submit():
        ...
        if form.password.data:
            ...
            if form.password.data != form.password2.data:
                ...
                return render_template('user_profile/default/edit_profile.html', form=form, title='Sửa Profile', user=user)
