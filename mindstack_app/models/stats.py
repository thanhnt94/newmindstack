...
class Achievement(db.Model):
    ...
    This might overlap with Gamification Badges, but this can be for strictly statistical milestones
    like "100 Day Streak" or "10k Cards".
    """
    ...
    data = db.Column(db.JSON, nullable=True) # Any extra metadata (e.g. the exact number reached)
