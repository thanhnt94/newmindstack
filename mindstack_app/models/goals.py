...
class UserGoal(db.Model):
    ...
    Replacing the legacy LearningGoal.
    """
    ...
    # Note: 'user' backref is defined in User model or here? 
    # Usually better to define one side. I'll depend on the backref from User or define here.
